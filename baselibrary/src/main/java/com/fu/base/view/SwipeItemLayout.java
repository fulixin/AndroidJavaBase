...
public class SwipeItemLayout extends FrameLayout {
    ...
    private int itemViewId;//显示view的资源id
    private int swipeViewId;//滑动显示的view资源id
    ...
    private void parseAttrs(AttributeSet attrs) {
        TypedArray arr = getContext().obtainStyledAttributes(attrs, R.styleable.SwipeLayoutStyle);
        ...
        arr.recycle();
        if (itemViewId != 0) {
            this.contentView = LayoutInflater.from(getContext()).inflate(itemViewId, this, false);
        }
        if (itemViewId != 0) {
            this.menuView = LayoutInflater.from(getContext()).inflate(swipeViewId, this, false);
        }
