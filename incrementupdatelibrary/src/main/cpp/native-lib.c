...
Java_com_fu_incrementupdate_update_Diffutils_generateDiffApk(JNIEnv *env, jclass type, jstring oldPath_,
...
JNIEXPORT jint JNICALL
Java_com_fu_incrementupdate_update_Diffutils_mergeDiffApk(JNIEnv *env, jclass type, jstring oldPath_,
                                            jstring newPath_, jstring patchPath_) {
